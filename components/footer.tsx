        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Transform your body, transform your life. Join the PowerFit community and achieve your fitness goals.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Classes", "Trainers", "Pricing", "Contact"].map((link) => (
                <li key={link}>
                  <Link
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">Subscribe for fitness tips and exclusive offers.</p>
